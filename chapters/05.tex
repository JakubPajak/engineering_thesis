...
\begin{itemize}
    ...
    \item Zasilanie – robot zasilany jest z pakietu czterech ogniw litowo-jonowych, dostarczających wysatraczjącą ilość napięcia oraz umożliwiających pracę przez odpowieni czas.
...
\subsection{Sposób aktywacji --->> JESLI WEB_APP TO DO ZMIANY !!!}
\label{sekcja:43}
