...
Często ze względu na realtywnie prostsze obliczenia, szczególnie podczas analizy stabilności oraz wyznaczania charakterystyk dynamicznych stosuje się postać operatorową (przekształcając równianie w postaci czasowej za pomocą operatora Laplace’a [\mathcal{L}]) regulatora PID. 
